...
class _ProWidgetState extends State<ProWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'pro'});
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRO_PAGE_Container_8sw5ntsx_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRO_PAGE_Container_juzjzolw_ON_TAP');
                                logFirebaseEvent('Container_navigate_to');

                                context
                                    .pushNamed(EditProfileCopyWidget.routeName);
                              },
                              child: Container(
                                width: double.infinity,
                                height: 60.0,
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRO_PAGE_Container_qenzkjq1_ON_TAP');
                                logFirebaseEvent('Container_navigate_to');
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRO_PAGE_Container_0pdo7rd9_ON_TAP');
                                logFirebaseEvent('Container_navigate_to');
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRO_PAGE_Container_s4d6rzns_ON_TAP');
                                logFirebaseEvent('Container_navigate_to');
