                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 48.0, 0.0, 0.0),
                                                child: Text(
                                                  'Ask Anything About the App or Meals , Enjoy healthy and delicious meals',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 48.0, 0.0, 0.0),
                                                child: AutoSizeText(
                                                  'Help Us Make Things Better, Your Suggestions Help Us Grow, How Can We Improve, Share Your Ideas for a Better Experience, and Give Us Feedback to Help Us Evolve.',
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
