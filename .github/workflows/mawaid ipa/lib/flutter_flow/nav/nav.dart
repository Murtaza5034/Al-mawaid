...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : SignWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) =>
                  params.isEmpty ? NavBarPage(initialPage: 'pro') : ProWidget(),
            ),
            FFRoute(
                name: ThaliSurveyWidget.routeName,
                path: ThaliSurveyWidget.routePath,
                requireAuth: true,
                builder: (context, params) => params.isEmpty
                    ? NavBarPage(initialPage: 'ThaliSurvey')
                    : NavBarPage(
                        initialPage: 'ThaliSurvey',
                        page: ThaliSurveyWidget(),
                      )),
            FFRoute(
            ...
            FFRoute(
              name: ElaanWidget.routeName,
              path: ElaanWidget.routePath,
              builder: (context, params) => ElaanWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: EditProfileCopyWidget.routeName,
              path: EditProfileCopyWidget.routePath,
              requireAuth: true,
              builder: (context, params) => EditProfileCopyWidget(),
            ),
            FFRoute(
              name: MondayWidget.routeName,
              path: MondayWidget.routePath,
              builder: (context, params) => MondayWidget(),
            ),
            FFRoute(
              name: TuesdayWidget.routeName,
              path: TuesdayWidget.routePath,
              builder: (context, params) => TuesdayWidget(),
            ),
            FFRoute(
              name: WednesdayWidget.routeName,
              path: WednesdayWidget.routePath,
              builder: (context, params) => WednesdayWidget(),
            ),
            FFRoute(
              name: ThursdayWidget.routeName,
              path: ThursdayWidget.routePath,
              builder: (context, params) => ThursdayWidget(),
            ),
            FFRoute(
              name: FridayWidget.routeName,
              path: FridayWidget.routePath,
              builder: (context, params) => FridayWidget(),
            ),
            FFRoute(
              name: SaturdayWidget.routeName,
              path: SaturdayWidget.routePath,
              builder: (context, params) => SaturdayWidget(),
            )
