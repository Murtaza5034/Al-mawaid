...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF0D7A6);
  ...
  late Color vibrantColor = const Color(0xFFD4B887);
  late Color lightVibrantColor = const Color(0xFFF7F1D1);
  late Color mutedColor = const Color(0xFFA87C7A);
  late Color lightMutedColor = const Color(0xFFB7807E);
}
